...
This project is a test task implementing a RESTful API for managing smartphones. It is built using PHP 8.4 and Laravel 13, strictly designed as a backend REST API (API-only) with no frontend assets, Node packages, or Blade templates.
